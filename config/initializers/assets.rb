...
Rails.application.config.assets.paths << Rails.root.join("app", "assets", "webpack", "dist")
Rails.application.config.assets.paths << Rails.root.join("app", "assets", "webpack", "node_modules")
